...
export REMTP_BLOCK_DELTA_BUDGET="$block_delta_budget"
...
export REMTP_BLOCK_MIN_TARGET_PROBABILITY="${BLOCK_MIN_TARGET_PROBABILITY:-0.001}"
export REMTP_BLOCK_MAX_TARGET_LOG_GAP="${BLOCK_MAX_TARGET_LOG_GAP:-8.0}"
export REMTP_BLOCK_MIN_PREFIX_REACH="${BLOCK_MIN_PREFIX_REACH:-0.01}"
export REMTP_BLOCK_TRUST_TOKEN_REFERENCE="${BLOCK_TRUST_TOKEN_REFERENCE:-0.25}"
export REMTP_BLOCK_TRUST_RELIABILITY_REFERENCE="${BLOCK_TRUST_RELIABILITY_REFERENCE:-0.6}"
export REMTP_BLOCK_TRUST_ACCEPTANCE_REFERENCE="${BLOCK_TRUST_ACCEPTANCE_REFERENCE:-0.01}"
export REMTP_BLOCK_AUDIT_INTERVAL="${BLOCK_AUDIT_INTERVAL:-0}"
export REMTP_BLOCK_DIAGNOSTICS="${BLOCK_DIAGNOSTICS:-0}"
export REMTP_BLOCK_COMPILE="${BLOCK_COMPILE:-1}"
